    <div class="row mb-4">
        <label for="title" class="col-sm-2 col-form-label">عنوان الميزه</label>
        <div class="col-sm-10">
            <input name="title" type="text" id="title" placeholder="ادخل عنوان للميزه"
    ...
    <div class="row mb-4">
        <label for="description" class="col-sm-2 col-form-label">وصف للميزه</label>
        <div class="col-sm-10">
            <textarea name="description" id="description" rows="3" placeholder="ادخل وصف للميزه"
    ...
    <div class="row mb-4">
        <label for="parent_id" class="col-sm-2 col-form-label">حالة الميزه</label>
        <div class="col-sm-10">
    ...
    <div class="row mb-4">
        <label class="col-sm-2 col-form-label">صوره</label>
        <div class="col-sm-10">
